...
:class:`PipelineConfig <youwol.pipelines.pipeline_raw_app.pipeline.PipelineConfig>`.
...
Refer to the function :func:`set_environment <youwol.pipelines.pipeline_raw_app.pipeline.set_environment>` to specify
other targets.
