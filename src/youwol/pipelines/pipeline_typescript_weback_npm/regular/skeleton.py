...
def generate_autogenerated(
    ...
    for pattern, repl in [
        [
            "'{{runTimeDependencies}}'",
            formatted_dumps(input_template.dependencies.runTime.dict()),
        ],
        ["'{{externals}}'", formatted_dumps(externals)],
        ["'{{exportedSymbols}}'", formatted_dumps(exported_symbols)],
        [
            "'{{mainEntry}}'",
            formatted_dumps(pop_aliases(input_template.bundles.mainModule)),
        ],
        ["'{{secondaryEntries}}'", formatted_dumps(secondary_entries)],
    ]:
