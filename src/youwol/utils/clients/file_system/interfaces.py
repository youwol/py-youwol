...
class FileSystemInterface(ABC):
    ...
    @abstractmethod
    async def get_info(self, object_id: str, **kwargs: Dict[str, Any]) -> JSON:
        """
    ...
    @abstractmethod
    async def set_metadata(self, object_id: str, metadata: Metadata, **kwargs) -> None:
        """
    ...
    async def get_object(
        self,
        object_id: str,
        ranges_bytes: List[Tuple[int, int]] = None,
        **kwargs: Dict[str, Any],
    ) -> bytes:
        """
    ...
    @abstractmethod
    async def remove_object(self, object_id: str, **kwargs: Dict[str, Any]) -> None:
        """
    ...
    async def remove_folder(
        self, prefix: str, raise_not_found: bool, **kwargs: Dict[str, Any]
    ) -> None:
        """
    ...
    async def list_objects(
        self, prefix: str, recursive: bool, **kwargs: Dict[str, Any]
    ) -> Iterable[FileObject]:
        """
