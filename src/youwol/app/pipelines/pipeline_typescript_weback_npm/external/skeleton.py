...
from youwol.app.pipelines.pipeline_typescript_weback_npm.common import generate_package_json, copy_files_folders, \
...
def generate_template(input_template: Template):
    ...
    copy_files_folders(working_path=working_path, base_template_path=Path(__file__).parent / 'templates',
