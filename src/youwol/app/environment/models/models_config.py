...
from youwol.app.environment.models.models import OnProjectsCountUpdate, ProjectsFinderHandler, ConfigPath
from youwol.app.environment.models.projects_finder_handlers import RecursiveProjectFinderHandler, \
    ExplicitProjectsFinderHandler
from youwol.app.environment.paths import PathsBook
from youwol.app.environment.models.defaults import default_path_cache_dir, default_path_data_dir, default_http_port, \
...
from youwol.utils import Context, encode_id, YouWolException, youwol_exception_handler, ResourcesNotFoundException, JSON
...
"""
    ...
    async def _forward_request(self, rest_of_path: str, headers: Dict[str, str]) -> Optional[Response]:
