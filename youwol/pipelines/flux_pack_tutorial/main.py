...
description = """
A skeleton to help you get started with writing flux-pack. Once the skeleton is installed:
 <ul> 
    <li> locate 'flux-pack-tutorial' in the dashboard ( My Computer > Packages) </li>
    <li> build, test and publish using the button <i class='far fa-arrow-alt-circle-right'></i> </li>
    <li> copy the link behind the name  'flux-pack-tutorial' and open it in your browser </li>
</ul>
"""
...
def get_targets(folder:  Union[str, Path]):
    return get_targets_generic(folder, "yw_pipeline_flux_pack_tutorial", TargetPackage)
