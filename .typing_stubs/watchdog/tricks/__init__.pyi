...
class ShellCommandTrick(Trick):
    ...
    process: Incomplete
    def __init__(self, shell_command: Incomplete | None = ..., patterns: Incomplete | None = ..., ignore_patterns: Incomplete | None = ..., ignore_directories: bool = ..., wait_for_process: bool = ..., drop_during_process: bool = ...) -> None: ...
    def on_any_event(self, event) -> None: ...
...
class AutoRestartTrick(Trick):
    ...
    def __init__(self, command, patterns: Incomplete | None = ..., ignore_patterns: Incomplete | None = ..., ignore_directories: bool = ..., stop_signal=..., kill_after: int = ...) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def on_any_event(self, event) -> None: ...
