...
class MinioAdmin:
    def __init__(
        self,
        target,
        binary_path: Incomplete | None = ...,
        config_dir: Incomplete | None = ...,
    ...
    def policy_set(
        self, policy_name, user: Incomplete | None = ..., group: Incomplete | None = ...
    ): ...
    def policy_unset(
        self, policy_name, user: Incomplete | None = ..., group: Incomplete | None = ...
    ): ...
