...
class CSVInputSerialization(InputSerialization):
    def __init__(self, compression_type: Incomplete | None = ..., allow_quoted_record_delimiter: Incomplete | None = ..., comments: Incomplete | None = ..., field_delimiter: Incomplete | None = ..., file_header_info: Incomplete | None = ..., quote_character: Incomplete | None = ..., quote_escape_character: Incomplete | None = ..., record_delimiter: Incomplete | None = ...) -> None: ...
    def toxml(self, element) -> None: ...

class JSONInputSerialization(InputSerialization):
    def __init__(self, compression_type: Incomplete | None = ..., json_type: Incomplete | None = ...) -> None: ...
    def toxml(self, element) -> None: ...
...
class CSVOutputSerialization:
    def __init__(self, field_delimiter: Incomplete | None = ..., quote_character: Incomplete | None = ..., quote_escape_character: Incomplete | None = ..., quote_fields: Incomplete | None = ..., record_delimiter: Incomplete | None = ...) -> None: ...
    def toxml(self, element) -> None: ...
...
class SelectRequest:
    def __init__(self, expression, input_serialization, output_serialization, request_progress: bool = ..., scan_start_range: Incomplete | None = ..., scan_end_range: Incomplete | None = ...) -> None: ...
    def toxml(self, element): ...
